...
?>
	...
	<section class="hero" id="header" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/hero-banner.svg)">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
			...
			<div class="row">
				<div class="col-12">
					<div class="section-title">
						<h2>Optimal <span>Plugins</span> for WordPress</h2>
	...
	<section class="expertise section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-title">
						<h2>Our Areas of <span>Expertise</span></h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="row justify-content-center">
						...
						<div class="col-lg-4">
							<div class="card card-border mx-auto mt-4">
								<div class="card-img">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/support.svg" alt="Icon">
								</div>
								<div class="card-body">
	...
	<!-- Reviews section -->
	<section class="reviews section-padding-bottom">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-title">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="row justify-content-center">
						<div class="col-lg-4">
							<div class="card review-card mx-auto">
								<div class="card-body">
									<div class="review">
										<span>5</span>
						...
						<div class="col-lg-4">
							<div class="card review-card card-zoom mx-auto">
								<div class="card-body">
									<div class="review">
										<span>5</span>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/review.svg" alt="Icon">
